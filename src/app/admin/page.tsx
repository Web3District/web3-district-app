    ...
    <div className="min-h-screen bg-[#0d0d0f] font-pixel text-[#e8dcc8]">
      ...
      <main className="p-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
          ...
          >
            <div className="text-5xl mb-4">🎁</div>
            <h3 className="text-xl text-[#ed0584] mb-2">Gift Center</h3>
            <p className="text-sm text-[#8c8c9c] mb-4">Send free shop items to users</p>
            <div className="flex items-center text-xs text-[#6a6a7a]">
          ...
          >
            <div className="text-5xl mb-4">📊</div>
            <h3 className="text-xl text-[#ed0584] mb-2">Analytics</h3>
            <p className="text-sm text-[#8c8c9c] mb-4">Track clicks, shares & interactions</p>
            <div className="flex items-center text-xs text-[#6a6a7a]">
              <span className="mr-2">🖱️ Clicks</span>
