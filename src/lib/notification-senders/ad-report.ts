...
export async function sendWeeklyAdReport(report: AdReport) {
  ...
  const bodyHtml = `
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin: 28px auto 0;">
      <tr>
        <td align="center" bgcolor="#ed0584" style="border-radius: 4px;">
          <a href="${escapeHtml(dashboardUrl)}" style="display: inline-block; padding: 14px 32px; background-color: #ed0584; border-radius: 4px; color: #111111; font-family: Helvetica, Arial, sans-serif; font-size: 14px; font-weight: bold; text-decoration: none; letter-spacing: 0.5px;">
            View Full Dashboard
          </a>
        </td>
      </tr>
