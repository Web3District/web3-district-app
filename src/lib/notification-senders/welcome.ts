...
export function sendWelcomeNotification(devId: number, login: string, rank?: number) {
  ...
  sendNotificationAsync({
    ...
    title: `Welcome to Web3 District, @${login}!`,
    body: `Your building is live in Web3 District. ${rankText} Check in daily to grow your streak and unlock items.`,
    html: `
      ...
      <p style="margin:0 0 20px; font-size:15px; color:#555555; line-height:1.6;">Web3 District is a living city built from GitHub contributions. Here's how to get started:</p>
